<?php if ( isset( $query_result ) && intval( $query_result->max_num_pages ) > 1 ) { ?>
	<div class="qodef-m-pagination qodef--load-more" <?php teenglow_is_installed( 'framework' ) && isset( $pagination_top_margin ) ? qode_framework_inline_style( $pagination_top_margin ) : ''; ?>>
		<div class="qodef-m-pagination-inner">
			...
			$button_params = array(
				...
				'link'          => '#',
				'text'          => esc_html__( 'Load More', 'teenglow' ),
			);
