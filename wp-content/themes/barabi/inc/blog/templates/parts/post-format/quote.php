...
if ( ! empty( $quote_text ) ) {
	...
	$quote_author_additional_info     = get_post_meta( get_the_ID(), 'qodef_post_format_quote_author_additional_info', true );
	...
	<div class="qodef-e-quote">
		...
		<?php } ?>
	<?php if ( ! empty( $quote_author ) ) { ?>
		<p class="qodef-e-quote-author-additional-info"><?php echo esc_html( $quote_author_additional_info ); ?></p>
	<?php } ?>
		<?php if ( ! is_single() ) { ?>
