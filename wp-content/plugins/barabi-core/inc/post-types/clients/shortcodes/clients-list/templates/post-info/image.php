		...
		<?php } ?>
			<?php if ( ! empty( $client_image ) ) { ?>
				<span class="qodef-e-logo">
					<?php if ( isset( $retina_scaling ) && 'yes' === $retina_scaling && is_array( $client_image_src ) ) { ?>
						<img itemprop="image" src="<?php echo esc_url( $client_image_src[0] ); ?>" width="<?php echo round( $client_image_src[1] / 2 ); ?>" height="<?php echo round( $client_image_src[2] / 2 ); ?>" alt="<?php echo esc_attr( $client_image_src[3] ); ?>" />
					<?php } else { ?>
			...
			<?php if ( ! empty( $client_hover_image ) ) { ?>
				<span class="qodef-e-hover-logo">
					<?php if ( isset( $retina_scaling ) && 'yes' === $retina_scaling && is_array( $client_hover_image_src ) ) { ?>
						<img itemprop="image" src="<?php echo esc_url( $client_hover_image_src[0] ); ?>" width="<?php echo round( $client_hover_image_src[1] / 2 ); ?>" height="<?php echo round( $client_hover_image_src[2] / 2 ); ?>" alt="<?php echo esc_attr( $client_hover_image_src[3] ); ?>" />
					<?php } else { ?>
