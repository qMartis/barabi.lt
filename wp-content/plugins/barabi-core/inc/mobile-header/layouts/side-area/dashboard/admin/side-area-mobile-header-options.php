...
if ( ! function_exists( 'barabi_core_add_side_area_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function barabi_core_add_side_area_mobile_header_options( $page, $general_tab ) {
	...
	add_action( 'barabi_core_action_after_mobile_header_options_map', 'barabi_core_add_side_area_mobile_header_options', 10, 2 );
}
