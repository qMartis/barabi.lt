...
if ( ! function_exists( 'barabi_core_dependency_for_mobile_menu_typography_options' ) ) {
	/**
	 * Function that set dependency values for module global options
	 *
	 * @return array
	 */
	function barabi_core_dependency_for_mobile_menu_typography_options() {
		return apply_filters( 'barabi_core_filter_mobile_menu_typography_hide_option', array() );
	}
}

if ( ! function_exists( 'barabi_core_set_mobile_header_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function barabi_core_set_mobile_header_styles( $style ) {
		$opener_styles    = array();
		$opener_color     = barabi_core_get_post_value_through_levels( 'qodef_mobile_header_opener_color' );
		$opener_icon_size = barabi_core_get_post_value_through_levels( 'qodef_mobile_header_opener_size' );
		...
		$opener_hover_color  = barabi_core_get_post_value_through_levels( 'qodef_mobile_header_opener_hover_color' );
	...
	add_filter( 'barabi_filter_add_inline_style', 'barabi_core_set_mobile_header_styles' );
}
