...
if ( ! class_exists( 'BarabiCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class BarabiCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'barabi_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return BarabiCore_Dashboard_Rest_API
		 */
	...
	BarabiCore_Dashboard_Rest_API::get_instance();
}
