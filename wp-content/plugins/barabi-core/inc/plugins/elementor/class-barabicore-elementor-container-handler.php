...
class BarabiCore_Elementor_Container_Handler {
	...
	/**
	 * @return BarabiCore_Elementor_Container_Handler
	 */
	...
	public function render_sticky_options( $container, $args ) {
		$container->start_controls_section(
			'qodef_sticky_column',
			array(
				'label' => esc_html__( 'Barabi Core Sticky Column', 'barabi-core' ),
				'tab'   => \Elementor\Controls_Manager::TAB_ADVANCED,
			)
		);
		...
		$container->add_control(
			...
			array(
				'label'        => esc_html__( 'Enable Sticky Column', 'barabi-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => '',
				'options'      => array(
					''       => esc_html__( 'No', 'barabi-core' ),
					'enable' => esc_html__( 'Yes', 'barabi-core' ),
				),
		...
		$container->add_control(
			...
			array(
				'label'        => esc_html__( 'Sticky Column Full Height', 'barabi-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'auto',
				'options'      => array(
					'auto'        => esc_html__( 'No', 'barabi-core' ),
					'full-height' => esc_html__( 'Yes', 'barabi-core' ),
				),
				'condition'    => array(
		...
		$container->add_control(
			...
			array(
				'label'        => esc_html__( 'Sticky Column Behavior Snap To', 'barabi-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => '',
				'options'      => array(
					''       => esc_html__( 'Middle', 'barabi-core' ),
					'top'    => esc_html__( 'Top', 'barabi-core' ),
					'bottom' => esc_html__( 'Bottom', 'barabi-core' ),
				),
				'condition'    => array(
		...
		$container->add_control(
			...
			array(
				'label'        => esc_html__( 'Sticky Column Behavior Disable From', 'barabi-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => '',
				'options'      => array(
					''     => esc_html__( 'Default', 'barabi-core' ),
...
if ( ! function_exists( 'barabi_core_init_elementor_container_handler' ) ) {
	/**
	 * Function that initialize main page builder handler
	 */
	function barabi_core_init_elementor_container_handler() {
		BarabiCore_Elementor_Container_Handler::get_instance();
	}

	add_action( 'init', 'barabi_core_init_elementor_container_handler', 1 );
}
