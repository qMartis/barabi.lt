...
if ( ! function_exists( 'barabi_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function barabi_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'BarabiCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'barabi_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class BarabiCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return BARABI_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function specific_icons() {
			return apply_filters(
				'barabi_core_filter_font_awesome_specific_icons',
				array(
					'search'        => 'fa fa-search',
		...
		function get_new_icons_list() {
			...
			if ( file_exists( BARABI_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( BARABI_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
