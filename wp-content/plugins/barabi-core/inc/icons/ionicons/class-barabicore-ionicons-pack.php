...
if ( ! function_exists( 'barabi_core_add_ionicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function barabi_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'BarabiCore_IonIcons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'barabi_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class BarabiCore_IonIcons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'barabi_core_filter_ion_specific_icons',
				array(
