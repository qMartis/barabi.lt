<li>
	<div class="<?php echo esc_attr( $comment_class ); ?>">
		<?php if ( ! $is_pingback_comment ) { ?>
			<div class="qodef-comment-image"> <?php echo get_avatar( $comment, apply_filters( 'barabi_filter_comment_gravatar_size', '60' ) ); ?> </div>
		<?php } ?>
						...
						<?php if ( ! isset( $rating['show'] ) || ( isset( $rating['show'] ) && $rating['show'] ) ) { ?>
							<span class="qodef-rating-inner">
								...
								<span class="qodef-rating-value">
									...
									echo barabi_core_reviews_get_rating_html( '', $review_rating, 0 );
									?>
								</span>
							</span>
						<?php } ?>
