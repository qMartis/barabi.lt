...
if ( ! function_exists( 'barabi_core_add_back_to_top_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function barabi_core_add_back_to_top_options( $page ) {
		...
		if ( $page ) {
			...
			$page->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Back to Top Icon SVG Path', 'barabi-core' ),
					'description' => esc_html__( 'Enter your back to top icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'barabi-core' ),
					'dependency'  => array(
						'show' => array(
			...
			$back_to_top_section = $page->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Back to Top Styles', 'barabi-core' ),
					'dependency' => array(
						'show' => array(
							'qodef_back_to_top' => array(
								'values'        => 'yes',
	...
	add_action( 'barabi_core_action_after_general_options_map', 'barabi_core_add_back_to_top_options', 15 );
}
