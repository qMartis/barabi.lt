...
if ( ! function_exists( 'barabi_core_add_page_logo_meta_box' ) ) {
	/**
	 * Function that add general meta box options for this module
	 *
	 * @param object $page
	 */
	function barabi_core_add_page_logo_meta_box( $page ) {
		...
		if ( $page ) {
			...
			$logo_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-logo',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Logo Settings', 'barabi-core' ),
					'description' => esc_html__( 'Logo settings', 'barabi-core' ),
				)
			);
			...
			$header_logo_section = $logo_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Header Logo Options', 'barabi-core' ),
				)
			);
			...
			$header_logo_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Logo Height', 'barabi-core' ),
					'description' => esc_html__( 'Enter logo height', 'barabi-core' ),
					'args'        => array(
			...
			$header_logo_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Logo Padding', 'barabi-core' ),
					'description' => esc_html__( 'Enter logo padding value (top right bottom left)', 'barabi-core' ),
				)
			);
			...
			$header_logo_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Logo Source', 'barabi-core' ),
					'options'       => array(
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Logo - Main', 'barabi-core' ),
					'description' => esc_html__( 'Choose main logo image', 'barabi-core' ),
					'multiple'    => 'no',
				)
			);
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Logo - Dark', 'barabi-core' ),
					'description' => esc_html__( 'Choose dark logo image', 'barabi-core' ),
					'multiple'    => 'no',
				)
			);
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Logo - Light', 'barabi-core' ),
					'description' => esc_html__( 'Choose light logo image', 'barabi-core' ),
					'multiple'    => 'no',
				)
			);

			// Hook to include additional options after section part
			do_action( 'barabi_core_action_after_header_logo_image_section_meta_map', $logo_tab, $header_logo_section, $logo_image_section );
			...
			do_action( 'barabi_core_action_before_header_logo_svg_path_section_meta_map', $logo_tab, $header_logo_section, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'barabi_core_action_after_header_logo_svg_path_section_meta_map', $logo_tab, $header_logo_section, $logo_svg_path_section );
			...
			// Hook to include additional options before section part
			do_action( 'barabi_core_action_before_header_logo_textual_section_meta_map', $logo_tab, $header_logo_section, $logo_textual_section );
			...
			// Hook to include additional options after section part
			do_action( 'barabi_core_action_after_header_logo_textual_section_meta_map', $logo_tab, $header_logo_section, $logo_textual_section );

			// Hook to include additional options after module options
			do_action( 'barabi_core_action_after_page_logo_meta_map', $logo_tab, $header_logo_section );
		}
	}

	add_action( 'barabi_core_action_after_general_meta_box_map', 'barabi_core_add_page_logo_meta_box' );
}

if ( ! function_exists( 'barabi_core_add_general_logo_meta_box_callback' ) ) {
	/**
	 ...
	 * @return array
	 */
	function barabi_core_add_general_logo_meta_box_callback( $callbacks ) {
		$callbacks['logo'] = 'barabi_core_add_page_logo_meta_box';

		return $callbacks;
	}

	add_filter( 'barabi_core_filter_general_meta_box_callbacks', 'barabi_core_add_general_logo_meta_box_callback' );
}
