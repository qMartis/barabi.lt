...
if ( ! function_exists( 'barabi_core_add_minimal_header_options' ) ) {
	/**
	 ...
	 */
	function barabi_core_add_minimal_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'       => 'qodef_minimal_header_section',
				'title'      => esc_html__( 'Minimal Header', 'barabi-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'barabi_core_action_after_header_options_map', 'barabi_core_add_minimal_header_options', 10, 2 );
}
