...
if ( ! function_exists( 'barabi_core_add_divided_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function barabi_core_add_divided_header_meta( $page ) {
	...
	add_action( 'barabi_core_action_after_page_header_meta_map', 'barabi_core_add_divided_header_meta' );
}
