...
class BarabiCore_Standard_Header extends BarabiCore_Header {
	...
	/**
	 * @return BarabiCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return barabi_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
