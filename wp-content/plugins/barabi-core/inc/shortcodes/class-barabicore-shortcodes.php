...
if ( ! class_exists( 'BarabiCore_Shortcodes' ) ) {
	class BarabiCore_Shortcodes {
		...
		function init() {
			...
			include_once BARABI_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once BARABI_CORE_SHORTCODES_PATH . '/class-barabicore-shortcode.php';
			include_once BARABI_CORE_SHORTCODES_PATH . '/class-barabicore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'barabi_core_filter_register_shortcodes', array() );
	...
	BarabiCore_Shortcodes::get_instance();
}
