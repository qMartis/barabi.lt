...
if ( ! function_exists( 'barabi_core_add_elements_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function barabi_core_add_elements_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'elements',
				'icon'        => 'fa fa-book',
				'title'       => esc_html__( 'Elements', 'barabi-core' ),
				'description' => esc_html__( 'Global Elements Options', 'barabi-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$label_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Label Styles', 'barabi-core' ),
				)
			);
			...
			$input_fields_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Input Fields Styles', 'barabi-core' ),
				)
			);
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Focus Color', 'barabi-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Background Focus Color', 'barabi-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Focus Color', 'barabi-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Width', 'barabi-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Radius', 'barabi-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Style', 'barabi-core' ),
			...
			$button_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Styles', 'barabi-core' ),
				)
			);
			...
			$button_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Box Shadow', 'barabi-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_simple_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Textual Styles', 'barabi-core' ),
				)
			);
			...
			$slider_arrow_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Slider Arrow Styles', 'barabi-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Left Icon SVG Path', 'barabi-core' ),
					'description' => esc_html__( 'Enter your sliders arrow left icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'barabi-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Right Icon SVG Path', 'barabi-core' ),
					'description' => esc_html__( 'Enter your sliders arrow right icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'barabi-core' ),
				)
			);
			...
			$slider_arrow_row = $slider_arrow_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Icon Styles', 'barabi-core' ),
				)
			);
			...
			do_action( 'barabi_core_action_after_elements_options_map', $page );
		}
	}

	add_action( 'barabi_core_action_default_options_init', 'barabi_core_add_elements_options' );
}
