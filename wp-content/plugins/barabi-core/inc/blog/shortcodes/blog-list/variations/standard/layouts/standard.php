<article <?php post_class( $item_classes ); ?>>
	<div class="qodef-e-inner">
		<?php
		// Include post media
		barabi_core_template_part( 'blog/shortcodes/blog-list', 'templates/post-info/media', '', $params );
		?>
		<div class="qodef-e-content">
			...
			<div class="qodef-e-text">
				...
				barabi_core_theme_template_part( 'blog', 'templates/parts/post-info/excerpt', '', $params );
			...
			<div class="qodef-e-bottom-holder">
				<div class="qodef-e-left qodef-e-info">
					...
					barabi_core_theme_template_part( 'blog', 'templates/parts/post-info/author' );
					?>
				</div>
				<div class="qodef-e-right qodef-e-info">
					<?php
					// Include post social share buttons
					barabi_core_theme_template_part( 'blog', 'templates/parts/post-info/social-share' );
					?>
				</div>
			</div>
		</div>
