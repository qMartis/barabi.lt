...
/**
 * Class BasicInvoice
 * Handles basic invoice data operations using WordPress post type
 */
class BasicInvoice
{
    /**
     ...
     */
    private $postType = 'we_basic_invoice';
    ...
    public function registerPostType(): void
    {
        $args = [
            ...
            'labels' => [
                'name' => __('Final Invoices', 'we-invoice'),
                'singular_name' => __('Final Invoice', 'we-invoice'),
                'menu_name' => __('Final Invoices', 'we-invoice'),
                'name_admin_bar' => __('Final Invoice', 'we-invoice'),
                'add_new' => __('Add New', 'we-invoice'),
                'add_new_item' => __('Add New Final Invoice', 'we-invoice'),
                'new_item' => __('New Final Invoice', 'we-invoice'),
                'edit_item' => __('Edit Final Invoice', 'we-invoice'),
                'view_item' => __('View Final Invoice', 'we-invoice'),
                'all_items' => __('All Final Invoices', 'we-invoice'),
                'search_items' => __('Search Final Invoices', 'we-invoice'),
                'parent_item_colon' => __('Parent Final Invoices:', 'we-invoice'),
                'not_found' => __('No Final invoices found.', 'we-invoice'),
                'not_found_in_trash' => __('No Final invoices found in Trash.', 'we-invoice'),
            ],
        ];
    ...
    public function create(array $data)
    {
        ...
        $post_data = [
            ...
            'post_title' => sprintf(__('Basic Invoice %s', 'we-invoice'), $invoiceNumber),
            'post_status' => 'publish',
            'post_content' => '',
            'meta_input' => [
                '_order_id' => $orderId,
    ...
    private function formatPostData($post): array
    {
        return [
            ...
            'invoice_type' => get_post_meta($post->ID, '_invoice_type', true) ?: 'basic',
