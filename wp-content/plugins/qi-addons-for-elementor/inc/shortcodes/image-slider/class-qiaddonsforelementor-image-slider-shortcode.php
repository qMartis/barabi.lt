...
if ( class_exists( 'QiAddonsForElementor_Slider_Shortcode' ) ) {
	class QiAddonsForElementor_Image_Slider_Shortcode extends QiAddonsForElementor_Slider_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/image-slider/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#image_slider' );
			$this->set_scripts(
				apply_filters(
