...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Pricing_Table_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/pricing-table/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#pricing_table' );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
