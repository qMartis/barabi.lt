...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Accordion_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/accordions-and-toggles/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#accordions_and_toggles' );
