...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Text_Marquee_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/text-marquee/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#text_marquee' );
