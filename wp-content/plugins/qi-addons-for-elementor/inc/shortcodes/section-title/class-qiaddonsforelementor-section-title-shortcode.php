...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Section_Title_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/section-title/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#section_title' );
