...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Tabs_Vertical_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/vertical-tabs/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#vertical_tabs' );
