...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Call_To_Action_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/call-to-action/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#call_to_action' );
