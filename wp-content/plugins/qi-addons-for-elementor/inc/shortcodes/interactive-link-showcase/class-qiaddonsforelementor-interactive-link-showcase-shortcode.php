...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Interactive_Link_Showcase_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/interactive-links/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#interactive_links' );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
