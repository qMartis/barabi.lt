...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Timeline_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/timeline-showcase/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#timeline_showcase' );
