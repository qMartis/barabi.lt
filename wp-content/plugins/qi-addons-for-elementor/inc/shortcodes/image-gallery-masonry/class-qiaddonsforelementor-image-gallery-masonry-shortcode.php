...
if ( class_exists( 'QiAddonsForElementor_List_Shortcode' ) ) {
	class QiAddonsForElementor_Image_Gallery_Masonry_Shortcode extends QiAddonsForElementor_List_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/masonry-image-gallery/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#masonry_image_gallery' );
			$this->set_scripts(
				apply_filters(
