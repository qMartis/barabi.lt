...
if ( class_exists( 'QiAddonsForElementor_Slider_Shortcode' ) ) {
	class QiAddonsForElementor_Blog_Slider_Shortcode extends QiAddonsForElementor_Slider_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/blog-carousel/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#blog_carousel' );
			$this->set_scripts(
				apply_filters(
