...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Contact_Form_7_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/contact-form-7/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#7_contact_form_7' );
