...
if ( class_exists( 'QiAddonsForElementor_List_Shortcode' ) ) {
	class QiAddonsForElementor_Product_Category_List_Shortcode extends QiAddonsForElementor_List_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_demo( 'https://barabi.jp/qi-addons-for-elementor/product-category-list/' );
			$this->set_documentation( 'https://barabi.jp/qi-addons-for-elementor/documentation/#4_product_category_list' );
