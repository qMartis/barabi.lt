...
if ( ! class_exists( 'Qi_Blocks_Accordion_Block' ) ) {
	class Qi_Blocks_Accordion_Block extends Qi_Blocks_Blocks {
		...
		public function __construct() {
			...
			$this->set_block_demo_url( 'https://barabi.jp/qi-blocks-for-gutenberg/accordions-and-toggles/' );
			$this->set_block_documentation( 'https://barabi.jp/qi-blocks-for-gutenberg/documentation/#accordions_and_toggles' );
