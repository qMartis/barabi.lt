...
if ( ! class_exists( 'Qi_Blocks_Image_Gallery_Pinterest_Block' ) ) {
	class Qi_Blocks_Image_Gallery_Pinterest_Block extends Qi_Blocks_Blocks {
		...
		public function __construct() {
			...
			$this->set_block_demo_url( 'https://barabi.jp/qi-blocks-for-gutenberg/pinterest-image-gallery/' );
			$this->set_block_documentation( 'https://barabi.jp/qi-blocks-for-gutenberg/documentation/#pinterest_image_gallery' );
