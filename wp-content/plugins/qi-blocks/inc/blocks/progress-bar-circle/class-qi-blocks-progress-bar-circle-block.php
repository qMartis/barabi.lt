...
if ( ! class_exists( 'Qi_Blocks_Progress_Bar_Circle_Block' ) ) {
	class Qi_Blocks_Progress_Bar_Circle_Block extends Qi_Blocks_Blocks {
		...
		public function __construct() {
			...
			$this->set_block_demo_url( 'https://barabi.jp/qi-blocks-for-gutenberg/radial-progress-bar/' );
			$this->set_block_documentation( 'https://barabi.jp/qi-blocks-for-gutenberg/documentation/#radial_progress_bar' );
