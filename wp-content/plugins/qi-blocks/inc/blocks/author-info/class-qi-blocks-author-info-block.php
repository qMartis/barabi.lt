...
if ( ! class_exists( 'Qi_Blocks_Author_Info_Block' ) ) {
	class Qi_Blocks_Author_Info_Block extends Qi_Blocks_Blocks {
		...
		public function __construct() {
			...
			$this->set_block_demo_url( 'https://barabi.jp/qi-blocks-for-gutenberg/author-info/' );
			$this->set_block_documentation( 'https://barabi.jp/qi-blocks-for-gutenberg/documentation/#author_info' );
