...
if ( ! class_exists( 'Qi_Blocks_Advanced_Text_Block' ) ) {
	class Qi_Blocks_Advanced_Text_Block extends Qi_Blocks_Blocks {
		...
		public function __construct() {
			...
			$this->set_block_demo_url( 'https://barabi.jp/qi-blocks-for-gutenberg/advanced-text/' );
			$this->set_block_documentation( 'https://barabi.jp/qi-blocks-for-gutenberg/documentation/#advanced_text' );
