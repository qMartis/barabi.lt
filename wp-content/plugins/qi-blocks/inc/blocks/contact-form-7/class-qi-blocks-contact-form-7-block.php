...
if ( ! class_exists( 'Qi_Blocks_Contact_Form_7_Block' ) ) {
	class Qi_Blocks_Contact_Form_7_Block extends Qi_Blocks_Blocks {
		...
		public function __construct() {
			...
			$this->set_block_demo_url( 'https://barabi.jp/qi-blocks-for-gutenberg/contact-form-7/' );
			$this->set_block_documentation( 'https://barabi.jp/qi-blocks-for-gutenberg/documentation/#contact_form_7' );
