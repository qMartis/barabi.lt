...
if ( ! class_exists( 'Qi_Blocks_Countdown_Block' ) ) {
	class Qi_Blocks_Countdown_Block extends Qi_Blocks_Blocks {
		...
		public function __construct() {
			...
			$this->set_block_demo_url( 'https://barabi.jp/qi-blocks-for-gutenberg/countdown/' );
			$this->set_block_documentation( 'https://barabi.jp/qi-blocks-for-gutenberg/documentation/#countdown' );
