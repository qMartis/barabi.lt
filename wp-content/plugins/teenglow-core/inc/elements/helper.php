...
if ( ! function_exists( 'teenglow_core_set_elements_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function teenglow_core_set_elements_styles( $style ) {
		$label_styles = teenglow_core_get_typography_styles( 'qodef_elements_label' );
		...
		$input_styles         = teenglow_core_get_typography_styles( 'qodef_elements_input_fields' );
		$fields_bg_color      = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_background_color' );
		$fields_border_color  = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_color' );
		$fields_border_width  = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_width' );
		$fields_border_radius = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_radius' );
		$fields_border_style  = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_style' );
		$fields_padding       = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_padding' );
		...
		$fields_focus_color        = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_focus_color' );
		$fields_bg_focus_color     = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_background_focus_color' );
		$fields_border_focus_color = teenglow_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_focus_color' );
		...
		$button_styles        = teenglow_core_get_typography_styles( 'qodef_elements_buttons' );
		$button_bg_color      = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_background_color' );
		$button_border_color  = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_border_color' );
		$button_border_width  = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_border_width' );
		$button_border_radius = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_border_radius' );
		$button_border_style  = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_border_style' );
		$button_box_shadow    = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_box_shadow' );
		$button_padding       = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_padding' );
		...
		$button_hover_color        = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_hover_color' );
		$button_bg_hover_color     = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_background_hover_color' );
		$button_border_hover_color = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_border_hover_color' );
		...
		$button_simple_styles = teenglow_core_get_typography_styles( 'qodef_elements_buttons_simple' );
		...
		$button_simple_hover_color           = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_simple_hover_color' );
		$button_simple_hover_text_decoration = teenglow_core_get_post_value_through_levels( 'qodef_elements_buttons_simple_hover_text_decoration' );
		...
		$slider_arrow_color    = teenglow_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_color' );
		$slider_arrow_bg_color = teenglow_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_background_color' );
		...
		$slider_arrow_svg_size   = teenglow_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_size' );
		...
		$slider_arrow_hover_color    = teenglow_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_hover_color' );
		$slider_arrow_bg_hover_color = teenglow_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_background_hover_color' );
	...
	add_filter( 'teenglow_filter_add_inline_style', 'teenglow_core_set_elements_styles' );
}
