...
if ( ! class_exists( 'TeenglowCore_Custom_Post_Types' ) ) {
	class TeenglowCore_Custom_Post_Types {
		...
		/**
		 * @return TeenglowCore_Custom_Post_Types
		 */
		...
		function init() {
			...
			include_once TEENGLOW_CORE_CPT_PATH . '/dashboard/customizer/post-types-customizer-options.php';
		}
		...
		function set_enabled_post_types() {
			...
			do_action( 'teenglow_core_action_add_custom_post_type', $this );
		}
		...
		function register_post_types() {
			...
			$cpts           = apply_filters( 'teenglow_core_filter_register_custom_post_types', array() );
		...
		function include_taxonomies() {
			...
			do_action( 'teenglow_core_action_include_cpt_tax_fields' );
		}

		function register_taxonomies() {
			// Hook to include custom post types taxonomy fields
			do_action( 'teenglow_core_action_register_cpt_tax_fields' );
		}
	...
	TeenglowCore_Custom_Post_Types::get_instance();
}
