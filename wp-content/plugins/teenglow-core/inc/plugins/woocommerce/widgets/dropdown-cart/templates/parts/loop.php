			...
			<li class="qodef-woo-mini-cart-item qodef-e">
				...
				echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					...
					sprintf(
						...
						teenglow_core_get_svg_icon( 'cart-remove' )
					),
					$cart_item_key
				);
				?>
				...
				<div class="qodef-e-content">
					...
					<?php echo teenglow_woo_product_get_rating_html( '', $rating ); ?>
					<p class="qodef-e-price">
						<?php echo apply_filters( 'woocommerce_widget_cart_item_quantity', '<span class="quantity">' . sprintf( '%s &times; %s', $cart_item['quantity'], WC()->cart->get_product_price( $_product ) ) . '</span>', $cart_item, $cart_item_key ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					</p>
				</div>
			</li>
			<?php
