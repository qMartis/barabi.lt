...
<li <?php wc_product_class( $item_classes ); ?>>
    <div class="qodef-e-inner">
        ...
        <div class="qodef-e-content">
            ...
            <?php teenglow_core_template_part( 'plugins/woocommerce/shortcodes/product-list', 'templates/post-info/rating-advanced', '', $params ); ?>
            ...
            <div class="qodef-e-product-buttons-holder">
                ...
                do_action( 'teenglow_core_action_product_list_item_additional_hover_content' );
                ?>
            </div>
            <?php
