...
class TeenglowCore_Elementor_Section_Handler {
	...
	/**
	 * @return TeenglowCore_Elementor_Section_Handler
	 */
	...
	public function render_background_text_options( $column, $args ) {
		$column->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Teenglow Core Background Text', 'teenglow-core' ),
				'tab'   => \Elementor\Controls_Manager::TAB_ADVANCED,
			)
		);
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Enable Background Text', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'no',
				'options'     => array(
					'no'  => esc_html__( 'No', 'teenglow-core' ),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Color', 'teenglow-core' ),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1440 and 1367 (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1366 and 1025 (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - below 1024 (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1440 and 1367 (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1366 and 1025 (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - below 1024 (px)', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Horizontal Align', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Left', 'teenglow-core' ),
					'center'     => esc_html__( 'Center', 'teenglow-core' ),
					'flex-end'   => esc_html__( 'Right', 'teenglow-core' ),
				),
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Align', 'teenglow-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Top', 'teenglow-core' ),
					'center'     => esc_html__( 'Middle', 'teenglow-core' ),
					'flex-end'   => esc_html__( 'Bottom', 'teenglow-core' ),
				),
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
	...
	public function render_sticky_options( $section, $args ) {
		$section->start_controls_section(
			'qodef_sticky_holder',
			array(
				'label' => esc_html__( 'Teenglow Core Sticky', 'teenglow-core' ),
				'tab'   => \Elementor\Controls_Manager::TAB_ADVANCED,
			)
		);
		...
		$section->add_control(
			'qodef_sticky_enable',
			array(
				'label'        => esc_html__( 'Make this column "Sticky"', 'teenglow-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => '',
				'options'      => array(
					''       => esc_html__( 'No', 'teenglow-core' ),
					'column' => esc_html__( 'Yes', 'teenglow-core' ),
				),
...
if ( ! function_exists( 'teenglow_core_init_elementor_section_handler' ) ) {
	/**
	 * Function that initialize main page builder handler
	 */
	function teenglow_core_init_elementor_section_handler() {
		TeenglowCore_Elementor_Section_Handler::get_instance();
	}

	add_action( 'init', 'teenglow_core_init_elementor_section_handler', 1 );
}
