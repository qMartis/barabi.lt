...
if ( ! function_exists( 'teenglow_core_add_side_area_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function teenglow_core_add_side_area_mobile_header_options( $page, $general_tab ) {
	...
	add_action( 'teenglow_core_action_after_mobile_header_options_map', 'teenglow_core_add_side_area_mobile_header_options', 10, 2 );
}
