...
if ( ! class_exists( 'TeenglowCore_Shortcodes' ) ) {
	class TeenglowCore_Shortcodes {
		...
		/**
		 * @return TeenglowCore_Shortcodes
		 */
		...
		function init() {
			...
			include_once TEENGLOW_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once TEENGLOW_CORE_SHORTCODES_PATH . '/class-teenglowcore-shortcode.php';
			include_once TEENGLOW_CORE_SHORTCODES_PATH . '/class-teenglowcore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'teenglow_core_filter_register_shortcodes', array() );
	...
	TeenglowCore_Shortcodes::get_instance();
}
