...
if ( ! function_exists( 'teenglow_core_add_single_image_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function teenglow_core_add_single_image_shortcode( $shortcodes ) {
		$shortcodes[] = 'TeenglowCore_Single_Image_Shortcode';

		return $shortcodes;
	}

	add_filter( 'teenglow_core_filter_register_shortcodes', 'teenglow_core_add_single_image_shortcode' );
}

if ( class_exists( 'TeenglowCore_Shortcode' ) ) {
	class TeenglowCore_Single_Image_Shortcode extends TeenglowCore_Shortcode {

		public function __construct() {
			$this->set_layouts( apply_filters( 'teenglow_core_filter_single_image_layouts', array() ) );
			$this->set_extra_options( apply_filters( 'teenglow_core_filter_single_image_extra_options', array() ) );

			parent::__construct();
		}

		public function map_shortcode() {
			$this->set_shortcode_path( TEENGLOW_CORE_SHORTCODES_URL_PATH . '/single-image' );
			$this->set_base( 'teenglow_core_single_image' );
			$this->set_name( esc_html__( 'Single Image', 'teenglow-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds image element', 'teenglow-core' ) );
			$this->set_scripts(
				array(
			...
			$this->set_option(
				array(
					'field_type' => 'select',
					'name'       => 'appear',
					'title'      => esc_html__( 'Appear Animation', 'teenglow-core' ),
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'teenglow_core_single_image', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return teenglow_core_get_template_part( 'shortcodes/single-image', 'variations/' . $atts['layout'] . '/templates/' . $atts['layout'], '', $atts );
		}
