...
if ( ! function_exists( 'teenglow_core_add_banner_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function teenglow_core_add_banner_shortcode( $shortcodes ) {
		$shortcodes[] = 'TeenglowCore_Banner_Shortcode';

		return $shortcodes;
	}

	add_filter( 'teenglow_core_filter_register_shortcodes', 'teenglow_core_add_banner_shortcode' );
}

if ( class_exists( 'TeenglowCore_Shortcode' ) ) {
	class TeenglowCore_Banner_Shortcode extends TeenglowCore_Shortcode {

		public function __construct() {
			$this->set_layouts( apply_filters( 'teenglow_core_filter_banner_layouts', array() ) );
			$this->set_extra_options( apply_filters( 'teenglow_core_filter_banner_extra_options', array() ) );

			parent::__construct();
		}

		public function map_shortcode() {
			$this->set_shortcode_path( TEENGLOW_CORE_SHORTCODES_URL_PATH . '/banner' );
			$this->set_base( 'teenglow_core_banner' );
			$this->set_name( esc_html__( 'Banner', 'teenglow-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds banner element', 'teenglow-core' ) );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
			...
			$this->set_option(
				array(
					'field_type'    => 'select',
					'name'          => 'text_tag',
					'title'         => esc_html__( 'Text Tag', 'teenglow-core' ),
					'options'       => teenglow_core_get_select_type_options_pool( 'title_tag' ),
					'default_value' => 'p',
			...
			$this->set_option(
				array(
					...
					'title'       => esc_html__( 'Content Padding', 'teenglow-core' ),
			...
			$this->set_option(
				array(
					...
					'title'       => esc_html__( 'Content Padding 1440', 'teenglow-core' ),
					'description' => esc_html__( 'Set padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'teenglow-core' ),
					'group'       => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'       => esc_html__( 'Content Padding 1366', 'teenglow-core' ),
					'description' => esc_html__( 'Set padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'teenglow-core' ),
					'group'       => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'       => esc_html__( 'Content Padding 1024', 'teenglow-core' ),
					'description' => esc_html__( 'Set padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'teenglow-core' ),
					'group'       => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'       => esc_html__( 'Content Padding 768', 'teenglow-core' ),
					'description' => esc_html__( 'Set padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'teenglow-core' ),
					'group'       => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'       => esc_html__( 'Content Padding 680', 'teenglow-core' ),
					'description' => esc_html__( 'Set padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'teenglow-core' ),
					'group'       => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			...
			$this->set_option(
				array(
					...
					'title'         => esc_html__( 'Fixed SVG Width', 'teenglow-core' ),
					'default_value' => '',
			...
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'svg_offset_top',
					'title'      => esc_html__( 'SVG Offset Top', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'SVG Offset Left', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'SVG Offset Top 1440', 'teenglow-core' ),
					'group'      => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'SVG Offset Left 1440', 'teenglow-core' ),
					'group'      => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'SVG Offset Top 1024', 'teenglow-core' ),
					'group'      => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'SVG Offset Left 1024', 'teenglow-core' ),
					'group'      => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'SVG Offset Top 680', 'teenglow-core' ),
					'group'      => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'SVG Offset Left 680', 'teenglow-core' ),
					'group'      => esc_html__( 'Responsive Style', 'teenglow-core' ),
				)
			);
		...
		public function render( $options, $content = null ) {
			...
			return teenglow_core_get_template_part( 'shortcodes/banner', 'variations/' . $atts['layout'] . '/templates/' . $atts['layout'], '', $atts );
		}
