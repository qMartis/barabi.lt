...
if ( ! function_exists( 'teenglow_core_add_ionicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function teenglow_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'TeenglowCore_IonIcons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'teenglow_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TeenglowCore_IonIcons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'teenglow_core_filter_ion_specific_icons',
				array(
