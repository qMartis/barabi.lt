...
if ( ! function_exists( 'teenglow_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function teenglow_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'TeenglowCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'teenglow_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TeenglowCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return TEENGLOW_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function specific_icons() {
			return apply_filters(
				'teenglow_core_filter_font_awesome_specific_icons',
				array(
					'search'        => 'fa fa-search',
		...
		function get_new_icons_list() {
			...
			if ( file_exists( TEENGLOW_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( TEENGLOW_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
