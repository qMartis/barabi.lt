...
if ( ! function_exists( 'teenglow_core_add_link_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function teenglow_core_add_link_typography_options( $page ) {
		...
		if ( $page ) {
			$link_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-link',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Link Typography', 'teenglow-core' ),
					'description' => esc_html__( 'Set values for link', 'teenglow-core' ),
				)
			);
	...
	add_action( 'teenglow_core_action_after_typography_options_map', 'teenglow_core_add_link_typography_options' );
}
