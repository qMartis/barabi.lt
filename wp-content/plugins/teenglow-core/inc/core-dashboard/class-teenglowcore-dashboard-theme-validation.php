...
if ( class_exists( 'TeenglowCore_Dashboard_Rest_API' ) ) {
	class TeenglowCore_Dashboard_Theme_Validation extends TeenglowCore_Dashboard_Rest_API {
		...
		/**
		 * @return TeenglowCore_Dashboard_Rest_API|TeenglowCore_Dashboard_Theme_Validation
		 */
		...
		public function register_rest_api_route() {
			...
			register_rest_route(
				...
				array(
					...
					'callback'            => array( TeenglowCore_Dashboard::get_instance(), 'theme_validation' ),
	...
	TeenglowCore_Dashboard_Theme_Validation::get_instance();
}
