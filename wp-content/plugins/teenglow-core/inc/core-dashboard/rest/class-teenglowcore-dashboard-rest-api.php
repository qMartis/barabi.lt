...
if ( ! class_exists( 'TeenglowCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class TeenglowCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'teenglow_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return TeenglowCore_Dashboard_Rest_API
		 */
	...
	TeenglowCore_Dashboard_Rest_API::get_instance();
}
