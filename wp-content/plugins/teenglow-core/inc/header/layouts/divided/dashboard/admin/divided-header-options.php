...
if ( ! function_exists( 'teenglow_core_add_divided_header_options' ) ) {
	/**
	 ...
	 */
	function teenglow_core_add_divided_header_options( $page, $general_header_tab ) {
	...
	add_action( 'teenglow_core_action_after_header_options_map', 'teenglow_core_add_divided_header_options', 10, 2 );
}
