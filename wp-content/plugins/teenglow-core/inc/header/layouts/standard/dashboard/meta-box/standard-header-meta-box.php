...
if ( ! function_exists( 'teenglow_core_add_standard_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function teenglow_core_add_standard_header_meta( $page ) {
	...
	add_action( 'teenglow_core_action_after_page_header_meta_map', 'teenglow_core_add_standard_header_meta' );
}
