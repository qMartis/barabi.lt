...
class TeenglowCore_Standard_Header extends TeenglowCore_Header {
	...
	public function __construct() {
		...
		$this->default_header_height = 112;
	...
	/**
	 * @return TeenglowCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return teenglow_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
