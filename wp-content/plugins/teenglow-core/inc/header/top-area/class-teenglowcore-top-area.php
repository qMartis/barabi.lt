...
class TeenglowCore_Top_Area {
	...
	public function __construct() {
		...
		add_action( 'teenglow_action_before_page_header', array( $this, 'load_template' ) );
		...
		add_filter( 'teenglow_filter_add_inline_style', array( $this, 'set_inline_top_area_styles' ) );
		add_filter( 'teenglow_core_filter_top_area_inner_class', array( $this, 'set_grid_class' ) );
	}

	/**
	 * @return TeenglowCore_Top_Area
	 */
	...
	function is_top_area_enabled() {
		$top_area_enabled = 'yes' === teenglow_core_get_post_value_through_levels( 'qodef_top_area_header' );
		$header_layout    = teenglow_core_get_post_value_through_levels( 'qodef_header_layout' );
	...
	public function set_top_area_height() {
		if ( $this->is_top_area_enabled ) {
			$height         = teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
	...
	public function is_top_area_transparent() {
		$background_color = teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_background_color' );
	...
	public function load_template() {
		...
		teenglow_core_template_part( 'header/top-area/', 'templates/top-area', '', $parameters );
	}
	...
	public function set_inline_top_area_styles( $style ) {
		...
		$height       = teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
		$side_padding = teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_side_padding' );
		$border_color = teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_border_color' );
		$border_width = teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_border_width' );
		$border_style = teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_border_style' );
	...
	public function set_grid_class( $classes ) {
		if ( 'yes' === teenglow_core_get_post_value_through_levels( 'qodef_top_area_header_in_grid' ) ) {
...
TeenglowCore_Top_Area::get_instance();
