...
class TeenglowCore_Above_Header_Area {
	...
	function is_top_area_enabled() {
		$above_header_area_enabled = teenglow_core_get_post_value_through_levels( 'qodef_above_header_area_header' ) === 'yes';
	...
	public function load_template() {
		...
		teenglow_core_template_part( 'header/above-header-area/', 'templates/above-header-area', '', $parameters );
	}
...
TeenglowCore_Above_Header_Area::get_instance();
