...
if ( ! function_exists( 'teenglow_core_add_sticky_header_meta_options' ) ) {
	/**
	 ...
	 */
	function teenglow_core_add_sticky_header_meta_options( $section, $custom_sidebars ) {
		...
		if ( $section ) {
			...
			$sticky_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Choose Custom Sticky Header Widget Area One', 'teenglow-core' ),
					'description' => esc_html__( 'Choose custom widget area to display in sticky header widget area one', 'teenglow-core' ),
			...
			$sticky_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Choose Custom Sticky Header Widget Area Two', 'teenglow-core' ),
					'description' => esc_html__( 'Choose custom widget area to display in sticky header widget area two', 'teenglow-core' ),
					'options'     => $custom_sidebars,
				)
			);
		}
	...
	add_action( 'teenglow_core_action_after_header_scroll_appearance_meta_options_map', 'teenglow_core_add_sticky_header_meta_options', 10, 2 );
}

if ( ! function_exists( 'teenglow_core_add_sticky_header_logo_meta_options' ) ) {
	/**
	 ...
	 */
	function teenglow_core_add_sticky_header_logo_meta_options( $logo_tab, $header_page, $logo_image_section ) {
	...
	add_action( 'teenglow_core_action_after_header_logo_image_section_meta_map', 'teenglow_core_add_sticky_header_logo_meta_options', 10, 3 );
}

if ( ! function_exists( 'teenglow_core_add_sticky_header_logo_svg_meta_options' ) ) {
	/**
	 ...
	 */
	function teenglow_core_add_sticky_header_logo_svg_meta_options( $page, $header_tab, $logo_svg_path_section ) {
	...
	add_action( 'teenglow_core_action_before_header_logo_svg_path_section_meta_map', 'teenglow_core_add_sticky_header_logo_svg_meta_options', 10, 3 );
}
